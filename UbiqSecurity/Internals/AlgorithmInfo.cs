...
namespace UbiqSecurity.Internals
{
    ...
    {
        private static AlgorithmInfo[] _supportedAlgorithms = new AlgorithmInfo[]
        {
        ...
        internal AlgorithmInfo(string name)
        {
            ...
            var match = _supportedAlgorithms.First(alg => alg.Name.Equals(name, StringComparison.OrdinalIgnoreCase));
        ...
        internal AlgorithmInfo(byte id)
        {
            ...
            var match = _supportedAlgorithms.First(alg => alg.Id == id);
