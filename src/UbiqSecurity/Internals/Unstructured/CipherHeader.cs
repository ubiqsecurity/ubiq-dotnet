...
namespace UbiqSecurity.Internals.Unstructured
{
    ...
    internal class CipherHeader
    {
        ...
        /// </summary>
        internal const byte FlagsAadEnabled = 0x01;
        internal const byte FlagsReserved1 = 0x02;
        internal const byte FlagsReserved2 = 0x04;
        internal const byte FlagsReserved3 = 0x08;
        internal const byte FlagsReserved4 = 0x10;
        internal const byte FlagsReserved5 = 0x20;
        internal const byte FlagsReserved6 = 0x40;
        internal const byte FlagsReserved7 = 0x80;
        ...
        /// <summary>Gets or sets Length of Initialization Vector, in bytes.</summary>
        internal byte InitVectorLength { get; set; }

        internal short EncryptedDataKeyLength { get; set; }

        /// <summary>
        /// Gets or sets Variable-length buffer of size <see cref="InitVectorLength"/>
        /// </summary>
        internal byte[] InitVectorBytes { get; set; }

        /// <summary>
        /// Gets or sets Variable-length buffer of size <see cref="EncryptedDataKeyLength"/>
        /// </summary>
